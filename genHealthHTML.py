...
def genHeader(wsid, wsNameDict, wsidDict, totalRankTable, popDict):
    ...
    header = '''	<div id="header">\n\
        ...
        <div id="info">\n\
        <p class="tw-b"><span class="txt16pt">Health Region</span><br>\n\
        {name}<br />\n\
...
def genMain(wsid, t, totalTable, rankTable, subNameDict, weblinks, tfDict):
    ...
    subTable += genSubTable(wsid, t, totalTable, rankTable, subNameDict, weblinks, tfDict, "# REGIONS WITH SUBSTANCE")
    subTable += "</div>\n"
    return subTable
...
def genHealthHTML(wsid, t, sourceList, icube, sourceDict, subNameDict, wsNameDict, weblinks, tfDict, popDict):

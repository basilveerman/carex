...
def genMain(wsid, t, totalTable, rankTable, subNameDict, weblinks, tfDict):
    ...
    subTable += genSubTable(wsid, t, totalTable, rankTable, subNameDict, weblinks, tfDict, "# ZONES WITH SUBSTANCE")
    subTable += "</div>\n"
    return subTable
...
def genEcozoneHTML(wsid, t, sourceList, icube, sourceDict, subNameDict, wsNameDict, weblinks, tfDict, popDict):

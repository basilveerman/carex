...
def genMain(wsid, t, totalTable, rankTable, subNameDict, sourceList, infoCube, sourceDict):
    ...
    <table width=\"100%\" cellspacing=\"0\" class=\"summary_sub\">\n\
        <thead>\n\
        <tr>\n\
            <th width=\"33%\">Substance</th>\n\
            <th width=\"33%\">Annual Amount (kg)</th>\n\
            <th width=\"34%\">Toxic Equivalent (Kg)</th>\n\
        </tr>\n\
        </thead>\n\
        <tbody>\n"
...
def genCanSummaryHTML(wsid, t, sourceList, icube, sourceDict, subNameDict, wsNameDict, popDict):

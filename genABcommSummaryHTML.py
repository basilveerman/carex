...
def genHeader(wsid, wsNameDict, wsidDict, totalRankTable, popDict):
    header = u'	<div id="header">\n\
        <img src="http://web.uvic.ca/~carex/files/logo_vert_150.png" alt="Logo"\
        width="150" height="150" class="logo" />\n\
        <div id="info">\n\
        <br><h1>' + wsNameDict[wsid].decode('latin-1') + '</h1><br>\n\
        Reported Population: ' + insert_thousands_separator(int(popDict[wsid])) + '<br />\n\
        </div>\n\
    </div>\n'
    return header
...
def genWrapper(wsid, t, sourceList, icube, sourceDict, subNameDict, wsNameDict, popDict):
    ...
    wrapper = u"<div id=\"summary_report\">\n"
...
def genABcommSummaryHTML(wsid, t, sourceList, icube, sourceDict, subNameDict, wsNameDict, popDict):

    html = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">\n\
    <html xmlns="http://www.w3.org/1999/xhtml">\n'
    html += unicode(genHTMLHead())

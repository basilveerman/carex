...
def genMain(wsid, t, totalTable, rankTable, subNameDict, weblinks, tfDict):
    ...
    subTable += genSubTable(wsid, t, totalTable, rankTable, subNameDict, weblinks, tfDict, "# COMMUNITIES WITH SUBSTANCE")
    subTable += "</div>\n"
    return subTable
...
def genABcommHTML(wsid, t, sourceList, icube, sourceDict, subNameDict, wsNameDict, weblinks, popDict, tfDict):

...
def genMain(wsid, t, totalTable, rankTable, subNameDict, sourceList, infoCube, sourceDict):
    subTable = '	<div id="mainContent_wshed">\n\
        <img src="http://web.uvic.ca/~carex/1/wshedloc/' + wsid + '.png" \
        alt="Watershed Location Map" class="wshed_loc" />\n\
        <p align="center">\n'
...
def genWshedSummaryHTML(wsid, t, sourceList, icube, sourceDict, subNameDict, wsNameDict, popDict):
